...
const socials = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/PanaceaSolution/",
    icon: (
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/panacea-solution-nepal",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/panaceasolutionnepal/",
    icon: (
      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="space-y-2.5 text-xs text-slate-400">
              ...
              <a href="tel:+9779708094314" className="flex items-center gap-2.5 hover:text-teal-400 transition-colors">
                <svg className="h-3.5 w-3.5 shrink-0 text-teal-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
